...
// Plain-text mirror of the FAQS list below, for the FAQPage structured data —
// kept separate because the displayed answers contain JSX links.
const FAQ_SCHEMA = [
  {
  ...
  },
  {
    ...
    a: `Free gets you ${FREE_SIMS} logic-check simulations and the full block editor, no account needed. Paying (KES ${PRICE_KES.toLocaleString("en-KE")} for ${PRO_DAYS} days) unlocks unlimited simulations and lets you download the actual .mq5 file to compile in MetaTrader.`,
  },
  {
  ...
  {
    q: "Do I need a VPS?",
    a: "Only if you want your bot to keep trading after you close your laptop — MT5 has to stay running.",
  },
  {
